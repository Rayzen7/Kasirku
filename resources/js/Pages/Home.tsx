...
const Home = () => {
    ...
    useEffect(() => {
        const fetchData = () => {
            ...
            setTransactionTotal(response.transaction_total);
        }
                ...
                <div className="flex justify-start items-center gap-8 mt-6">
                    <div className="bg-white px-6 py-5 rounded-lg w-[260px] h-[140px] flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-2 justify-end">
                            <p className='font-poppins_medium text-[30px]'>{productCount}</p>
                    ...
                    <div className="bg-white px-6 py-5 rounded-lg w-[260px] h-[140px] flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-2 justify-end">
                            <p className='font-poppins_medium text-[30px]'>{transactionCount}</p>
                    ...
                    <div className="bg-white px-6 py-5 rounded-lg w-[260px] h-[140px] flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-2 justify-end">
                            <p className='font-poppins_medium text-[22px]'>{RupiahFormat(transactionTotal)}</p>
